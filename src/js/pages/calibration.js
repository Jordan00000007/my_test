...
import calibrationHtml from '../../html/pages/calibration.html';
...
import { CalibrationHandler } from '../library/calibrationHandler';
...
export default function home() {
    ...
    view.innerHTML = headerHtml+calibrationHtml;
    ...
    $(doc).ready(async () => {
        ...
        calibrationHandler.drawChart();
        calibrationHandler.setCalendarButtonClickEvent();
        calibrationHandler.setDateSubmitButtonClickEvent();
        calibrationHandler.setCalculateButtonClickEvent();
        calibrationHandler.setDownloadButtonClickEvent();
        calibrationHandler.setUploadConfigButtonClickEvent();
        calibrationHandler.setCompanyList();
        calibrationHandler.setT1ButtonClickEvent();
        calibrationHandler.setT2ButtonClickEvent();
